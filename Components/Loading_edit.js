...
const Loading = ({navigation }) => {
  ...
  const CreationBd=()=>{
    ...
    db.transaction((tx) => {
      ...
      tx.executeSql('create table if not exists categorie (id_categorie integer primary key autoincrement, categorie text, sous_categorie text,icon_categorie text,deleted text, last_modified datetime)');
      ...
      tx.executeSql('create table if not exists personne_attente (id_personne_attente integer primary key autoincrement,date_ticket date, id_prestation text, total_attente text)');
      ...
      tx.executeSql('create table if not exists prestations (id_prestation integer primary key autoincrement, lib_prestation text, prefixe_prestation text,  icon_prestation text, deleted text, last_modified datetime, statut_img integer, id_categorie text)');
